"""
Django settings for beerServer project.
...
SECRET_KEY = '0rze#xrm&&w7i1%a(ci0iq!&@t^2rkj*p_^ho7r^fyoc1l=4e$'
...
MIDDLEWARE = [
    ...
    'gqlserver.middleware.JWTMiddleware',
...
WSGI_APPLICATION = 'beerServer.wsgi.application'
